...
dinnerPlannerApp.config(['$routeProvider',
  ...
  //Trying to implement a back button that is equivalent to the browser's back button, but not working
  dinnerPlannerApp.directive('backButton', function() {
    return {
      restrict: 'E',
      template: '<button id="backButtonOverview" class="btn">{{back}}</button>',
      scope: {
        back: '@back',
      },
